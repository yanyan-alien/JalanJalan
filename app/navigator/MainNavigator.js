...
export default function MainNavigator({navigation}) {
  return (
    ...
    >
      ...
      <Stack.Group screenOptions={{title:"HEALTH", headerTitleAlign:"center"}}>
      ...
      <Stack.Group screenOptions={{title:"TAXI", headerTitleAlign:"center"}}>
        <Stack.Screen name="Taxi" component={TaxiScreen} />
      </Stack.Group>
      <Stack.Group screenOptions={{title:"FOOD", headerTitleAlign:"center"}}>
      ...
      <Stack.Group screenOptions={{title:"EMERGENCY", headerTitleAlign:"center"}}>
